        ...
        <header className="w-full p-4 sm:p-5 shadow-md sticky top-0 z-20 bg-gradient-to-r from-sky-300 via-indigo-300 to-violet-300 backdrop-blur-sm">
            <nav className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    <img src="https://psgtech.edu/dept/ece/ieee/img/logo/psg.png" alt="PSG Main Logo" className="h-10 sm:h-12 w-auto" />
                ...
                <div className="hidden md:flex items-center space-x-2 sm:space-x-4">
                    ...
                    <Link to="/login" className="text-gray-800 font-semibold px-3 sm:px-4 py-2 rounded-lg transition-colors hover:bg-sky-200">Login</Link>
            ...
            {isOpen && (
                <div className="md:hidden mt-4">
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        <Link to="/login" onClick={() => setIsOpen(false)} className="w-full text-center text-gray-800 font-semibold px-3 sm:px-4 py-2 rounded-lg transition-colors hover:bg-sky-200">Login</Link>
